...
register_activation_hook( __FILE__, 'yml_install' );



function yml_install(){



}

add_action( 'admin_menu', 'yml_add_admin_menu' );
...
function yml_add_admin_menu(  ) {
    ...
    add_menu_page( 'Импорт в Яндекс Маркет', 'Импорт в Яндекс Маркет', 'manage_options', 'yandex', 'yml_options_page' );
...
add_action( 'admin_init', 'yml_general_init' );

add_action( 'admin_init', 'yml_file_init' );

add_action( 'admin_init', 'yml_category_init' );
